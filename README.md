...
```bash
curl -fsSL [https://raw.githubusercontent.com/Biziol/project-runner/Dev/pjrunner.sh](https://raw.githubusercontent.com/Biziol/project-runner/Dev/pjrunner.sh) | bash
```
